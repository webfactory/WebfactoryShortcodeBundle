...
- XML-based routing configuration has been deprecated in Symfony 7.4. Switch to PHP-based routing configuration by including
  `guide-routing.php` instead of `guide-routing.xml`. A deprecation notice will be triggered.
